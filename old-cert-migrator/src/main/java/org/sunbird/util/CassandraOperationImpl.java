...
//        LoggerEnum.INFO.name());
    ...
    try {
      ...
      Where selectWhere = select.from(keyspaceName, tableName).where();
      key.entrySet()
          .stream()
          .forEach(
              x -> {
...
//          ResponseCode.SERVER_ERROR.getResponseCode());
  ...
  @Override
  public Response getRecordsWithLimit(String keySpace, String table, Map<String, Object> filters, List<String> fields, Integer limit) {
    Response response = new Response();
